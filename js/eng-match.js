    ...
    for(var i=0; i<6; i++) {
        ...
        for(var j=0; j<3; j++) {
            ...
            appendItem += `<div class="col-md-4 p-2 mt-2">
                                  <span class="badge rounded-pill text-bg-warning text-warning fs-4" onclick="onClickMatch('${matchContent[i*3+j]}', '#mat${i*3+j}');" id="mat${i*3+j}">${matchContent[i*3+j]}</span>
                              </div>`;
        }
